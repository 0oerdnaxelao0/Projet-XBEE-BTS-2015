...
namespace Application_xbee_recepteur_données
{
    class C_Xbee
    {
        ...
        //public delegate void MessageEventHandler(object sender, MessageEventArgs e); //délégu

        //public delegate void EventHandler(int cmd, object y);
        //public event EventHandler ReceiveEvent = delegate { };
    }
}
